...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the face metadata
        ...
        # The PEP 517 backend we should use to build the face
    ...
    def prepare_metadata(self):
        # type: () -> None
        """Ensure that face metadata is available.
        ...
        if not self.req:
            ...
            if canonicalize_name(self.req.name) != metadata_name:
                logger.warning(
                    ...
                    'produced metadata for face name %s. Fix your '
                    '#egg=%s fragments.',
