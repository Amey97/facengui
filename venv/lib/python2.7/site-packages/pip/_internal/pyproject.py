...
def load_pyproject_toml(
    ...
    Parameters:
        ...
        pyproject_toml - Location of the face's pyproject.toml file
        setup_py - Location of the face's setup.py file
    ...
    if has_pyproject and not has_setup:
        ...
        if use_pep517 is not None and not use_pep517:
            raise InstallationError(
                "Disabling PEP 517 processing is invalid: "
                "face specifies a build backend of {} "
    ...
    # we do so if the face has a pyproject.toml file.
